...
class EntertaiMentPage extends StatefulWidget {
  const EntertaiMentPage({super.key});
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        //controller: scrollcontroller,
                          ...
                          itemCount: state.entertainmentnews.articles!.length,
                                  ...
                                  child: GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>InformationScreen(
                                        title: state.entertainmentnews.articles![index].title.toString(),
                                        description: state.entertainmentnews.articles![index].description.toString(),
                                        Content:state.entertainmentnews.articles![index].content.toString() ,
                                        Image: state.entertainmentnews.articles![index].urlToImage!,
                                        authorname: state.entertainmentnews.articles![index].author.toString(),)));
                                    },
                                    child: Column(
                                      children: [
                                        ClipRRect(
                                          borderRadius: BorderRadius.circular(10),
                                          child: state.entertainmentnews.articles![index].urlToImage == null ? const Image(image: AssetImage(ImageAssets.defaultimage,),fit: BoxFit.fill) :
                                          Image(
                                            image:
                                            NetworkImage(state.entertainmentnews.articles![index].urlToImage.toString()),
                                            fit: BoxFit.fill,
                                          )
                                        ),
                                        SizedBox(
                                            ...
                                            width: screenSize.width,
                                            child: Text(
                                              state.entertainmentnews.articles![index].title.toString(),
                                              style: UpdateStyle.CustomeTextStyle(
                                                  screenSize.width / 20,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(state.entertainmentnews.articles![index].publishedAt!.toUtc().toString(),
                                                style: UpdateStyle.CustomeTextStyle(
                                                    screenSize.width / 25,
                                                    FontWeightManager.regular,
                                                    ColorManager.gray)),
