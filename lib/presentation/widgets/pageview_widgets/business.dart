                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        //  physics: NeverScrollableScrollPhysics(),
                          itemCount: state.businessnews.articles!.length,
                                  ...
                                  child: GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>InformationScreen(
                                        title: state.businessnews.articles![index].title.toString(),
                                        description: state.businessnews.articles![index].description.toString(),
                                        Content:state.businessnews.articles![index].content.toString() ,
                                        Image: state.businessnews.articles![index].urlToImage!,
                                        authorname: state.businessnews.articles![index].author.toString(),)));
                                    },
                                    child: Column(
                                      children: [
                                        ClipRRect(
                                          borderRadius: BorderRadius.circular(10),
                                          child: state.businessnews.articles![index].urlToImage == null ? const Image(image: AssetImage(ImageAssets.defaultimage,),fit: BoxFit.fill) :
                                          Image(
                                            image:
                                            NetworkImage(state.businessnews.articles![index].urlToImage.toString()),
                                            fit: BoxFit.fill,
                                          )
                                        ),
                                        SizedBox(
                                            ...
                                            width: screenSize.width,
                                            child: Text(
                                              state.businessnews.articles![index].title.toString(),
                                              style: UpdateStyle.CustomeTextStyle(
                                                  screenSize.width / 20,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(state.businessnews.articles![index].publishedAt!.toUtc().toString(),
                                                style: UpdateStyle.CustomeTextStyle(
                                                    screenSize.width / 25,
                                                    FontWeightManager.regular,
                                                    ColorManager.gray)),
