                      ...
                      child: ListView.builder(
                        //controller: scrollcontroller,
                         // physics: NeverScrollableScrollPhysics(),
                          itemCount: state.technews.articles!.length,
                                  ...
                                  child: GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>InformationScreen(
                                        title: state.technews.articles![index].title.toString(),
                                        description: state.technews.articles![index].description.toString(),
                                        Content:state.technews.articles![index].content.toString() ,
                                        Image: state.technews.articles![index].urlToImage!,
                                        authorname: state.technews.articles![index].author.toString(),)));
                                    },
                                    child: Column(
                                      children: [
                                        ClipRRect(
                                          borderRadius: BorderRadius.circular(10),
                                          child: state.technews.articles![index].urlToImage == null ? const Image(image: AssetImage(ImageAssets.defaultimage,),fit: BoxFit.fill) :
                                          Image(
                                            image:
                                            NetworkImage(state.technews.articles![index].urlToImage.toString()),
                                            fit: BoxFit.fill,
                                          )
                                        ),
                                        SizedBox(
                                            ...
                                            width: screenSize.width,
                                            child: Text(
                                              state.technews.articles![index].title.toString(),
                                              style: UpdateStyle.CustomeTextStyle(
                                                  screenSize.width / 20,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(state.technews.articles![index].publishedAt!.toUtc().toString(),
                                                style: UpdateStyle.CustomeTextStyle(
                                                    screenSize.width / 25,
                                                    FontWeightManager.regular,
                                                    ColorManager.gray)),
