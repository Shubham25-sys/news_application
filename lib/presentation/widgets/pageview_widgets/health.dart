                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        //controller: scrollcontroller,
                          ...
                          itemCount: state.helthnews.articles!.length,
                                  ...
                                  child: GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>InformationScreen(
                                        title: state.helthnews.articles![index].title.toString(),
                                        description: state.helthnews.articles![index].description.toString(),
                                        Content:state.helthnews.articles![index].content.toString() ,
                                        Image: state.helthnews.articles![index].urlToImage!,
                                        authorname: state.helthnews.articles![index].author.toString(),)));
                                    },
                                    child: Column(
                                      children: [
                                        ClipRRect(
                                          borderRadius: BorderRadius.circular(10),
                                          child: state.helthnews.articles![index].urlToImage == null ? const Image(image: AssetImage(ImageAssets.defaultimage,),fit: BoxFit.fill) :
                                          Image(
                                            image:
                                            NetworkImage(state.helthnews.articles![index].urlToImage.toString()),
                                            fit: BoxFit.fill,
                                          )
                                        ),
                                        SizedBox(
                                            ...
                                            width: screenSize.width,
                                            child: Text(
                                              state.helthnews.articles![index].title.toString(),
                                              style: UpdateStyle.CustomeTextStyle(
                                                  screenSize.width / 20,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(state.helthnews.articles![index].publishedAt!.toUtc().toString(),
                                                style: UpdateStyle.CustomeTextStyle(
                                                    screenSize.width / 25,
                                                    FontWeightManager.regular,
                                                    ColorManager.gray)),
